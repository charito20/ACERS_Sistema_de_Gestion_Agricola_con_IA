...
Carpeta a cargo de la analista de requerimientos.
...
| `priorizacion_moscow_kano.csv` | Los 39 requisitos funcionales con MoSCoW, Kano, los cuatro valores WSJF y el ranking. |

Estandar base: ISO/IEC/IEEE 29148:2018 y ISO/IEC 25010:2023. Enfoque metodologico: legal-first (Amaral et al., 2021). La matriz de trazabilidad esta en `04_Trazabilidad/`.
