...
**P7 (carpeta 10_Autoria, elementos A1 a A12), resuelto:** de los 12 elementos exigidos, los 12 tienen ya contenido real (bitacora, capturas, diagramas fuente, doble codificacion, correspondencia, declaracion de uso de IA, aporte individual, inventario EXIF, .mailmap). Las tres carpetas que estaban vacias se completaron: grabaciones/ (2 grabaciones de sesion de equipo), fotos_equipo/ (fotos del equipo) y notas_campo/ (17 notas de campo manuscritas, una por entrevista, ENTR-01 a ENTR-17; ver correccion en 07_Datos/desviaciones.md, la desviacion que declaraba esta carpeta vacia fue un error de verificacion durante la auditoria, no una omision real).
