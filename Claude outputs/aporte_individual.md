...
- **Estado (actualizado):** Robinson comunicó al equipo su intención de retomar el trabajo antes del cierre de esta entrega. A la fecha de esta nota, el repositorio no registra commits suyos posteriores al 2026-09-01 (el commit `89e0f97` que corrige su correo en `CITATION.cff` fue realizado por Roselyn Sánchez, no por él). Se le asignaron las carpetas de evidencia de autoría aún vacías — `10_Autoria/grabaciones/`, `10_Autoria/notas_campo/`, `10_Autoria/correspondencia/`, `10_Autoria/fotos_equipo/` — y la revisión/defensa de la sección de Discusión del manuscrito. Conforme al gatekeeper P8, su factor individual de esta entrega se determinará por la contribución verificable que efectivamente quede acreditada a su nombre en el repositorio y por su participación en la defensa oral (G7); si al cierre de la entrega no hay commits propios ni participación en la defensa, el factor individual corresponde a cero con independencia de la calificación del equipo.

## Kamila Annabella Calle Delgado (`kcalled`)
- **Rol:** Modelado UML; mockups; inventario de insumos y requerimientos no funcionales; modelo legal-first (`Modelo_Legal_LOPDP.md`, ERS completo); cierre técnico del manuscrito y gestión del depósito FAIR.
- **Archivos responsables:** `03_Modelado/Diagrams/`, `03_Modelado/Mockups/`, `04_Trazabilidad/Matriz_Trazabilidad_v2.xlsx`, `01_ERS/ERS_SRS_2B_v2.0.*`, `01_ERS/Modelo_Legal_LOPDP.md`.
- **Commits acreditados:** `1112d1c`, `2a09b0c`, `406c402`, `57ac7dd`, `5bb864d`, `6a0bb7f`, `c712b60`, `e8ce337`.
- **Tareas en curso (tras el retiro de Robinson):** verificación de DOI real de cada referencia de `07_Publicacion/referencias.bib`; ejecución de la lista de verificación previa (`10_Autoria/verificacion_previa.pdf`, gatekeeper P11) sobre el manuscrito; depósito del paquete de replicación en Zenodo con DOI persistente; registro externo verificable en OSF; obtención del SWHID en Software Heritage (gatekeepers G3). Pendiente al cierre de esta nota.

## Danela Dayana Arteaga Álava (`darteagaa-boop`)
- **Rol:** Elicitación de requisitos; entrevistas; codificación de evidencia; anexos éticos.
- **Archivos responsables:** `02_Evidencias/Transcripciones/`, `02_Evidencias/Codificacion_Tematica/`, `08_Etica/`.
- **Commits acreditados:** `8bf3f1e`, `e66788a`, `f902721`.
