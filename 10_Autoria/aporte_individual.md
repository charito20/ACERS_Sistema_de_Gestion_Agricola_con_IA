...
- **Archivos en los que contribuyó:** `01_ERS/Modelo_Legal_LOPDP.md` (versión inicial), `11_Publicacion/manuscrito_final.tex` (borrador inicial), `06_Experimento/osf_registration.md` (versión inicial).
