...
> Firmado por los cinco integrantes (nombre y firma) en la sección final.

## Jeanpierre Robinson Espinoza (`jean200525`)
- **Rol:** Coordinación metodológica; enfoque legal-first; redacción del manuscrito.
- **Archivos responsables:** `01_ERS/Modelo_Legal_LOPDP.md`, `07_Publicacion/manuscrito_final.tex`, `07_Publicacion/referencias.bib`, `06_Experimento/osf_registration.md`.
- **Commits acreditados:** `1a584b6`, `1e71755`, `238a64f`, `25c700e`, `561349d`, `5c6b297`, `6a51a93`, `75402f6`, `8041a53`, `87efd34`, `b7f350d`, `c22595b`, `d011b42`, `e0481e5`, `feaf392`.

## Kamila Annabella Calle Delgado (`kcalled`)
- **Rol:** Modelado UML; mockups; inventario de insumos y requerimientos no funcionales.
- **Archivos responsables:** `03_Modelado/Diagrams/`, `03_Modelado/Mockups/`, `04_Trazabilidad/Matriz_Trazabilidad_v2.xlsx`.
