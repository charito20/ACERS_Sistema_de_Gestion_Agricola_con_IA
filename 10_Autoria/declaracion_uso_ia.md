...
|---|---|---|---|---|
| Portada e historial | Claude Sonnet 5 (redacción, interfaz de chat, sin control de temperatura) | Redacción de metadatos y resumen | María Escudero | Lectura y contraste con el contenido |
...
| Sección | Herramienta | Para qué | Quién verificó | Método de verificación |
|---|---|---|---|---|
| Título y resumen | Claude Sonnet 5 (redacción, interfaz de chat, sin control de temperatura) | Pulido y ajuste a plantilla | Jeanpierre Robinson | Coherencia con datos y guía |
| Introducción | Claude Sonnet 5 (redacción, interfaz de chat, sin control de temperatura) | Pulido de párrafos ya escritos | Jeanpierre Robinson | Contraste con evidencia del dominio |
...
| Discusión | Claude Sonnet 5 (redacción, interfaz de chat, sin control de temperatura) | Pulido de redacción | María Escudero | Trazabilidad a datos de resultados |
| Amenazas a la validez | — | Sin uso de IA | Equipo | Basado en Wohlin et al. |
| Conclusiones | Claude Sonnet 5 (redacción, interfaz de chat, sin control de temperatura) | Pulido de redacción | Roselyn Sánchez | Contraste con hallazgos de resultados |
