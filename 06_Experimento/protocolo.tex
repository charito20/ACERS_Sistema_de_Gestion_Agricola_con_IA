...
\item \textbf{Meta de entrevistas:} al menos 16 entrevistas distintas, 24 recomendadas. Estado actual, 17 entrevistas completas con 17 personas confirmadas como distintas entre si. De esas 17, un subconjunto sirvio ademas como sesion de validacion con walkthrough (7 codigos ENTR segun el ERS/SRS, 4 con perfiles tecnicos y 5 con perfiles no tecnicos segun el desglose de \texttt{justificacion\_muestra.md}, cifras pendientes de reconciliar entre si). Los walkthroughs se hicieron dentro de las entrevistas mismas, no como sesiones ni grabaciones separadas, confirmado con el equipo el 2026-09-04. Se detecto y corrigio un conteo previo de 16 entrevistas tras verificar el numero real de audios y consentimientos firmados (17 de cada uno), y se corrigio la relacion walkthrough/entrevista de "sesiones separadas" (17+9=26) a "subconjunto" de las 17.
