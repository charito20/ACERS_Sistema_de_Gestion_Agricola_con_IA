...
\item \textbf{Meta de entrevistas:} al menos 16 entrevistas distintas, 24 recomendadas. Estado actual, 17 entrevistas completas con 17 personas confirmadas como distintas entre si, mas 9 sesiones de validacion con walkthrough, 4 con perfiles tecnicos y 5 con perfiles no tecnicos. Se detecto y corrigio un conteo previo de 16 entrevistas tras verificar el numero real de audios y consentimientos firmados (17 de cada uno).
