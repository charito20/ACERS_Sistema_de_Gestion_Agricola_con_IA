...
El an\'alisis de cobertura se ejecuta con los scripts de \texttt{06\_Experimento/scripts\_analisis/} sobre la matriz de los 26 criterios legales. Los resultados se organizan en dos partes, la cobertura global antes y despu\'es del m\'etodo legal-first, con la prueba de McNemar y el intervalo de confianza de la diferencia de proporciones por bootstrap, y el desglose descriptivo de la cobertura por bloque normativo y por fuente de evidencia.
...
Esta secci\'on responde a la pregunta de investigaci\'on con la evidencia de la secci\'on de resultados, consolida las contribuciones y enuncia al menos tres l\'ineas de trabajo futuro que otros equipos puedan retomar a partir del paquete de replicaci\'on depositado.
